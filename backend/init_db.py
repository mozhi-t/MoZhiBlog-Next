...
""",
                ...
                "tags": f"{tags[0].id},{tags[1].id}",  # Vue3, 前端
                "type": 0,  # 文章
                "read_count": 128
            },
            {
...
""",
                ...
                "tags": f"{tags[3].id},{tags[4].id}",  # UI, UX
                "type": 0,  # 文章
                "read_count": 256
            },
            {
...
""",
                ...
                "tags": f"{tags[5].id},{tags[6].id}",  # 生活, 自我成长
                "type": 0,  # 文章
                "read_count": 89
            },
            {
...
""",
                "category_id": categories[0].id,  # 技术
                "tags": f"{tags[2].id},{tags[1].id}",  # TypeScript, 前端
                "type": 0,  # 文章
                "read_count": 167
            },
            {
...
""",
                "category_id": categories[2].id,  # 生活
                "tags": f"{tags[6].id},{tags[5].id}",  # 自我成长, 生活
                "type": 0,  # 文章
                "read_count": 203
            }
        ]
