...
本博客搭建与24年10月8号，其实之前在初中的时候就想建一个网站了，可惜当时没有太多能力和时间，导致一直在搁置，现在也算是圆了小时候一个梦想。博客之前一直使用的是WordPress，但因为访问比较卡等一些原因，使我在25年年尾时开始自学vue等一些框架并开发属于自己的博客系统（当然也有AI的帮助），现在的博客的设计风格我很满意，启动速度也不错，但是可能还是有一些安全性的问题我没有检查出来（其实写的是一坨屎罢了），这是开源链接：[MoZhiBlog-Next](https://github.com/mozhi-t/MoZhiBlog-Next)
